...
int main()
{
	...
	printf("LoopDelay                       | Func : %10lld | Calc : %10lld | \n", LoopFuncDelay, LoopDelay);
	printf("LoopWait_stl_ThreadDelay        | Func : %10lld | Calc : %10lld | \n", LoopWaitStlThreadFuncDelay, LoopWaitStlThreadDelay);
	printf("LoopWaitCreateThreadDelay       | Func : %10lld | Calc : %10lld | \n", LoopWaitCreateThreadFuncDelay, LoopWaitCreateThreadDelay);
	printf("LoopWaitBeginThreadDelay        | Func : %10lld | Calc : %10lld | \n", LoopWaitBeginThreadFuncDelay, LoopWaitBeginThreadDelay);
	printf("EventWaitCreateThreadDelay      | Func : %10lld | Calc : %10lld | \n", EventWaitCreateThreadFuncDelay, EventWaitCreateThreadDelay);
	printf("EventWaitBeginThreadDelay       | Func : %10lld | Calc : %10lld | \n", EventWaitBeginThreadFuncDelay, EventWaitBeginThreadDelay);
	printf("microThreadDelay                | Func : %10lld | Calc : %10lld | \n", microThreadFuncDelay, microThreadDelay);
	printf("microThreadConcurrentQueueCheck | Func : %10lld | Calc : %10lld | \n", microThreadConcurrentQueueFuncDelay, microThreadConcurrentQueueDelay);
	printf("ThreadPoolDelay                 | Func : %10lld | Calc : %10lld | \n", ThreadPoolFuncDelay, ThreadPoolDelay);
}
